    ...
    <section className="flex flex-col gap-6 mx-auto max-w-[1272px] justify-between">
      <Breadcrumb className="font-semibold">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink className="capitalize" href={`/noticia/${slug.name}`}>{slug.name}</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage className="capitalize text-primary font-semibold">{slug.slug}</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
        ...
        <div className="flex flex-col lg:flex-row w-full gap-2 rounded-2xl">
          {
            <div className="flex flex-col gap-3 rounded-xl p-2 transition">
              ...
              <div className="relative max-w-[340px] lg:max-w-[840px] h-[475px] rounded-md overflow-hidden">
                <Image
                  src={postFiltered?.image ? postFiltered.image : ""}
                  alt={postFiltered?.title ? postFiltered?.title : ""}
                  fill
